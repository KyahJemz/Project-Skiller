                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-4">
                        <div class="col d-flex flex-column gap-2">
                            <div class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3 p-2 w-25">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi" viewBox="0 0 16 16">
                        ...
                        <div class="col d-flex flex-column gap-2">
                            <div class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3 p-2 w-25">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                        ...
                        <div class="col d-flex flex-column gap-2">
                            <div class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3 p-2 w-25">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" class="bi bi-trophy" viewBox="0 0 16 16">
                            ...
                            <h4 class="fw-semibold mb-0 text-body-emphasis">Master</h4>
                            <p class="text-body-secondary"> Indicating proficiency and expertise in mathematics, suggesting that the tutorial system aims to assist users in becoming masters of the subject.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="AboutUs" class="row p-5">
                <div class="row">
                    <div class="col-lg-4 d-flex flex-column" >
                        ...
                        <h4 class="fw-normal text-center">Jaspe E. Iyana</h4>
                        <p class="fw-normal text-center">Team Leader</p>
                    </div>
                    <div class="col-lg-4 d-flex flex-column" >
                        <image src="<?php echo BASE_URL . 'images/m2.jpg'?>" alt="image" class="bd-placeholder-img rounded-circle m-auto border" width="140" height="140"/>
                        <h4 class="fw-normal text-center">Stronger R. Sosa</h4>
                        <p class="fw-normal text-center">Programmer</p>
                        </div>
                    <div class="col-lg-4 d-flex flex-column" >
                        <image src="<?php echo BASE_URL . 'images/m3.jpg'?>" alt="image" class="bd-placeholder-img rounded-circle m-auto border" width="140" height="140"/>
                        <h4 class="fw-normal text-center">Lord Anthony S. Capistrano</h4>
                        <p class="fw-normal text-center">Programmer</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column" >
                        <image src="<?php echo BASE_URL . 'images/m4.jpg'?>" alt="image" class="bd-placeholder-img rounded-circle m-auto border" width="140" height="140"/>
                        <h4 class="fw-normal text-center">Jay Rico C. Calderon</h4>
                        <p class="fw-normal text-center">System Analyst</p>
                    </div>
                    <div class="col-lg-6 d-flex flex-column" >
                        <image src="<?php echo BASE_URL . 'images/m5.jpg'?>" alt="image" class="bd-placeholder-img rounded-circle m-auto border" width="140" height="140"/>
                        <h4 class="fw-normal text-center">Edison MC Gregor D. Mendoza</h4>
                        <p class="fw-normal text-center">Documentation Specialist</p>
                    </div>
                </div>
            </div>
